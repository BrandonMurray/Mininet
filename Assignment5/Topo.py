...
def myNetwork():	
	...
	h2 = net.addHost('h2', ip='10.0.0.2/24', mac='00:00:00:00:00:01')
	info( '*** Add Links\n')
	net.addLink(h1, s6)
	net.addLink(h2, s2)
#-------------------------------------------
	...
	net.addLink(s2, s8, cls=TCLink, bw=2)
	net.addLink(s2, s7, cls=TCLink, bw=4)
	...
	net.addLink(s4, s6, cls=TCLink, bw=3)
	net.addLink(s4, s7, cls=TCLink, bw=2)
	net.addLink(s5, s6, cls=TCLink, bw=1)
	net.addLink(s6, s7, cls=TCLink, bw=4)
	net.addLink(s7, s8, cls=TCLink, bw=12)
